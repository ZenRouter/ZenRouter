 ...
 * API. They are zenroute fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic zenroute variant set for a single upstream Kiro model.
 *
 ...
 * into zenroute variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
