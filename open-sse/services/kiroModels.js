 ...
 * into zenrouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are zenrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic zenrouter variant set for a single upstream Kiro model.
 *
 ...
 * into zenrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
