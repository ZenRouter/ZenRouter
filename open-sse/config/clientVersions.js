...
//
// Sources verified 2026-09-17 against:
//   - Claude Code 2.1.274                          (anthropics/claude-code GitHub
//     release, published 2026-09-17; npm is now only a native-installer stub — the
//     registry tarball ships a `claude.exe` bootstrap, so version sourcing is
//     GitHub-first, npm-last-resort)
//   - @openai/codex 0.154.0 (npm latest + upstream stable Sep 10)
//   - @google/gemini-cli 0.60.0                   (npm latest; core still pins
//     @google/genai@1.30.0 exact in packages/core/package.json at v0.60.0)
//   - google-antigravity/antigravity IDE 2.12.2 / CLI 1.1.25 (antigravity.google/changelog, Sep 3)
//   - Antigravity IDE Desktop 2.12.2               (official changelog)
...
//     released Sep 9; the marketplace standalone lags — bundled-in-VSCode is what real users run)
//   - Kiro IDE 1.0.437 / CLI 2.21.0                (kiro.dev/changelog, Sep 1)
//   - TraeCode IDE 3.5.91                          (trae docs changelog:
//     3.5.89–3.5.91 Aug 19 hotfix)
//   - CodeBuddy CLI 2.151.0                        (@tencent-ai/codebuddy-code npm latest)
...
// 2.1.274 (2026-09-17) — latest release; supports Fable 5.1 and updated flags.
...
// ─── OpenAI Codex ──────────────────────────────────────────────────────
// 0.154.0 (npm latest 2026-09-17). Two surfaces:
...
// ─── Antigravity ───────────────────────────────────────────────────────
// Antigravity IDE Desktop 2.12.2 (2026-09-03: Gemini 3.8 Flash via ADC for Enterprise).
// Antigravity CLI is on a separate line (1.1.25, released 2026-09-03) — the IDE is what we impersonate.
export const ANTIGRAVITY_IDE_VERSION = "2.12.2";
...
//   - IDE line 1.0.x (1.0.437 is the newest published, Sep 1) → client fingerprint
...
export const KIRO_IDE_VERSION = "1.0.437";
