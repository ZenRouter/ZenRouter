...
describe("Claude → Kiro (direct route)", () => {
  ...
  it("injects thinking_mode tag into conversation content when model implies thinking", () => {
  ...
  it("sends Claude system as user-content fallback without unsupported top-level systemPrompt", () => {
    const out = C2K({
