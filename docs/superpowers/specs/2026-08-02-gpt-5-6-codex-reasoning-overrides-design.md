...
The same matrix applies to zenroute's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside zenroute;
  zenroute only forwards the catalog-advertised reasoning override.
