...
The same matrix applies to zenrouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside zenrouter;
  zenrouter only forwards the catalog-advertised reasoning override.
