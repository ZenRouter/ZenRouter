    ...
    <div className="mt-16 w-full max-w-4xl relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite]">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-7">
        {CLI_TOOLS.map((tool) => (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-[#141b24] border border-[#233044] flex items-center justify-center overflow-hidden p-2 hover:border-[#4B72A4]/60 transition-all hover:scale-105">
              <ProviderIcon
                src={tool.image}
                alt={tool.name}
                size={48}
      ...
      >
        <path
          ...
          fill="none"
          stroke={activeFlow === 0 ? "#5D87B8" : "rgb(51, 65, 85)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 1 ? "#E85D3F" : "rgb(51, 65, 85)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 2 ? "#5D87B8" : "rgb(51, 65, 85)"}
        ...
        <path
          ...
          fill="none"
          stroke={activeFlow === 3 ? "#5D87B8" : "rgb(51, 65, 85)"}
      ...
      <div className="absolute right-0 top-0 bottom-0 flex flex-col justify-between py-6">
        {PROVIDERS.map((provider, idx) => (
          <div
            key={provider.id}
            className={`px-4 py-2 rounded-lg ${provider.color} ${provider.textColor} flex items-center justify-center font-semibold text-xs shadow-lg hover:scale-110 transition-all cursor-help min-w-[140px] ${
              activeFlow === idx ? "ring-4 ring-[#5D87B8]/60 scale-110" : ""
            }`}
            title={provider.name}
          >
            {provider.name}
      ...
      {/* Mobile fallback */}
      <div className="md:hidden mt-8 w-full p-4 rounded-lg bg-[#141b24] border border-[#233044]">
