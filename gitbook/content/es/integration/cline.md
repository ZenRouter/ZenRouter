...
Integra ZenRoute con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de ZenRoute.
...
Establece la URL base a tu endpoint de ZenRoute:
...
**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de ZenRoute
...
3. La key debe comenzar con `sk-zenroute-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de ZenRoute
...
4. Cline usará ZenRoute para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando ZenRoute
...
3. Obtén explicaciones potenciadas por IA a través de ZenRoute

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará ZenRoute para entender el contexto y hacer cambios
...
2. Verifica que tu instancia de ZenRoute esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de ZenRoute para cualquier error
...
1. En la configuración de Cline, establece Base URL a: `https://zenroute.dev`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de ZenRoute
...
## Integración con características de ZenRoute

### Enrutamiento de modelos

ZenRoute enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, ZenRoute automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de ZenRoute:
