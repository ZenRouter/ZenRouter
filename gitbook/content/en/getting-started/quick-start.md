...
Get ZenRouter running in 5 minutes and start routing AI requests intelligently.
...
- Default password: `12345678` (change in dashboard)
...
Point your coding tool to ZenRouter:
