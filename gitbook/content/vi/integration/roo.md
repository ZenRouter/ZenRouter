...
Tích hợp ZenRoute với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model ZenRoute có sẵn:
...
### Connection Failed
- Xác minh ZenRoute đang chạy: `curl http://localhost:20128/health`
